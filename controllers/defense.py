...
def get_variance_html(over_expected):
    ...
    html +=         "<div>Take for example ATL Defense Vs QB Week 1. They played Jalen Hurts who was projected 19.3 points but scored 28.76 points.</div>"
    html +=         "<div>var = ((actual / projected) - 1) * 100"
    html +=         "<br>var = ((28.76 / 19.3) - 1) * 100 = +49.02%</div>"
    html +=         "<div>This means that Hurts scored 49% more fantasy points than was projected. We then add up all the projected and actual points across every week and calculate the percentage as a whole for the defense.<br>The same can be calculated for WR/RB as a whole unit.</div>"
