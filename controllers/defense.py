...
def get_variance_html(over_expected):
    ...
    html +=         "<div>Take for example ARI Defense Vs QB Week 1. They played Pat Mahomes who was projected 23.21 points but scored 34.9 points.</div>"
    html +=         "<div>var = ((actual / projected) - 1) * 100"
    html +=         "<br>var = ((34.9 / 23.21) - 1) * 100 = +50.37%</div>"
    html +=         "<div>This means that Mahomes scored 50.37% more fantasy points than was projected. We then add up all the projected and actual points across every week and calculate the percentage as a whole for the defense.<br>The same can be calculated for WR/RB as a whole unit.</div>"
