...
def fix_projections(all_projections):
	...
	arr = ["michael badgley", "ryan santoso"]
	for player in arr:
	...
	all_projections["matt ammendola"] = {
		...
		"wk4": 4.83, "wk5": 5.33, "wk8": 5.21, "wk9": 5.32
	}
	...
	all_projections["joey slye"]["wk7"] = 6.81
	all_projections["joey slye"]["wk8"] = 6.32

	all_projections["rodrigo blankenship"]["wk6"] = 6.20
	all_projections["rodrigo blankenship"]["wk7"] = 6.20
	all_projections["rodrigo blankenship"]["wk8"] = 6.20
